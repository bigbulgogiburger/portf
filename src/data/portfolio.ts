...
export const projects: Project[] = [
  {
    ...
    metric: "A/S 업무 모델·권한·정산 기준 설계", metricLabel: "고객사와 설계 기준을 맞추며 개발",
  ...
  },
  {
    ...
    summary: "서비스 본체와 결제 서버를 분리하고, Apple 환불 검증에서 재시도가 실행되지 않던 오류를 호출 구조 변경으로 해결했습니다.",
...
export const capabilities: { title: string; caption: string; skills: Skill[] }[] = [
  ...
  { title: "Frontend & Tools", caption: "화면 개발·유지보수 · 결제 연동", skills: [
    ...
    { name: "React · Next.js", where: "수리엔 화면 유지보수 · 이관 원본" },
